      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl pt-[160px]">
          ...
          <p className=" mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to DIGI, where our carefully curated collection of
            fashion-forward items meets uncompromising quality and style.
          </p>
          <div className=" flex flex-col sm:flex-row gap-4 mt-6">
            <Link href="/products/category/all" className={buttonVariants()}>
