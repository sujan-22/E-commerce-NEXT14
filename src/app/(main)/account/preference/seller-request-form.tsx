      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Fill out the form below to request seller access. You must agree to
            our terms and conditions before submitting your request.
          </p>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      You must agree to our seller terms before proceeding.
                    </FormDescription>
                  </div>
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel>
                      I understand that my request can be denied
                    </FormLabel>
                    <FormDescription>
                      Acknowledging that your request is subject to approval.
                    </FormDescription>
                  </div>
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel>
                      I agree that my seller access can be revoked if necessary
                    </FormLabel>
                    <FormDescription>
                      Seller access may be revoked if suspicious activity is
                      detected.
                    </FormDescription>
                  </div>
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel>
                      I agree that each product will be reviewed before going
                      live
                    </FormLabel>
                    <FormDescription>
                      Ensuring product compliance with platform standards.
                    </FormDescription>
                  </div>
                </FormItem>
              )}
